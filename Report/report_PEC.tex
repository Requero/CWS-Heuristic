...
Para beta = 0.8, que es el caso más cercano a un comportamiento greedy como tiene el algoritmo base. Vemos que la aleatorización sesga y el uso de la caché de rutas siguen funcionando bien. Observamos que la diferencia de coste con la solución inicial es menor. Al acercarnos al comportamiento base reducimos la diferencia entre las soluciones.\\
Con la subdivisión apreciamos el mismo comportamiento. Para los casos que tenían instancias mejoradas, estas siguen estando entre el 40 y 50\% pero el margen de mejora es menor.
